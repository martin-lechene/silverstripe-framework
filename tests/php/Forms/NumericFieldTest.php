...
class NumericFieldTest extends SapphireTest
{
    ...
    public function dataForTestSetValue()
    {
        return [
            ...
            // de_CH
            ['de_CH', 0, '13000', "13’000"],
            ['de_CH', 0, '15', '15'],
            ['de_CH', null, '12.0', '12.0'],
            ['de_CH', null, '12.1', '12.1'],
            ['de_CH', 1, '14000.5', "14’000.5"],
            // nl
    ...
    public function dataForTestSubmittedValue()
    {
        return [
            ...
            ['de_DE', 1, '15,000.5', false],
            // de_CH (Swiss German)
            ['de_CH', 0, '13000', 13000, '13’000'],
            ['de_CH', 2, '12,00', false],
            ['de_CH', 2, '12.00', 12.00],
            ['de_CH', 1, '11 000', 11000, "11’000.0"],
            ['de_CH', 0, "11.000", 11, "11"],
            ['de_CH', null, '11,000', 11000.0, '11’000.0'],
            ['de_CH', 1, '15 000,5', false],
            ['de_CH', 1, "15 000.5", 15000.5, '15’000.5'],
            ['de_CH', 1, '15.000,5', false],
            ['de_CH', 1, '15,000.5', 15000.5, '15’000.5'],
            // nl_nl (same as de)
